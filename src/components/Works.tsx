...
const works = [
  ...
  },
  {
    ...
    label: "|sevenc-nanashi/|library_w4nderers",
    footerUrl: "https://github.com/sevenc-nanashi/library_w4nderers",
    footerText: "",
    github: "sevenc-nanashi/library_w4nderers",
    language: "TypeScript (p5.js), Original Song",
  },
  {
    id: "favorit3sRespect",
    name: "favorit3s.respect",
    url: "https://www.nicovideo.jp/watch/sm44635263",
    label: "|sevenc-nanashi/|favorit3s_respect",
    footerUrl: "https://github.com/sevenc-nanashi/favorit3s_respect",
    footerText: "",
    github: "sevenc-nanashi/favorit3s_respect",
    language: "TypeScript (p5.js), Original Song",
  },
  {
    id: "2Lyrics",
...
export const translations = {
  ja: {
    ...
    favorit3sRespectDescription: "メドレー。3作目。映像をp5.jsで制作。",
    libraryW4nderersDescription: "自作曲。4作目。映像をp5.jsで制作。",
    unidentifiedSignpo5tsDescription: "自作曲。5作目。映像をp5.jsで制作。",
  ...
  en: {
    ...
    favorit3sRespectDescription: "A medley. My third song. The video was made with p5.js.",
    libraryW4nderersDescription: "My fourth original song. The video was made with p5.js.",
    unidentifiedSignpo5tsDescription: "My fifth original song. The video was made with p5.js.",
